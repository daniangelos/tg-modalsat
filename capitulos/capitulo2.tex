...
exemplo, de conhecimento e crença, respectivamente~\cite{artigoquefaladeknowledgeebelief} --- isto é, em resumo %forçado
, a base da estrutura
...
\begin{definition}[Regras de Necessidade Básicas]
    Para qualquer prefixo $\sigma$:
    \begin{mathpar}
\label{doublenegation}
        \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
...
\begin{definition}[Regras especiais de necessidade]
    \begin{mathpar}
\label{conj_rules}
        T \quad \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
        \inferrule{\sigma~\neg\neg X}{\sigma~X} \\
        D \quad \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
        \inferrule{\sigma~\neg\neg X}{\sigma~X} \\
        B \quad \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
        \inferrule{\sigma~\neg\neg X}{\sigma~X} \\
        4 \quad \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
        \inferrule{\sigma~\neg\neg X}{\sigma~X} \\
        4r \quad \inferrule{\sigma~\neg\neg X}{\sigma~X} \qquad
        \inferrule{\sigma~\neg\neg X}{\sigma~X} 
    \end{mathpar}
